...
import Pricecolormanagement from "./service-add-parlour";
export default class Create extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      LONG: null,
      thumbnail: "",
      selectOwnerCity: null,
      selectSalonCity: null,
    };
  }
  handleBack() {
  ...
  handleSubmit = (event) => {
    ...
    swal({
      ...
      if (success) {
        let list = await GetSalonDetails.addSalonDetails(formData, config);
        if (list) {
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-lg-5 col-md-9 col-lg-6">
                <h2 className="mt-30 page-title">Parlour Create</h2>
              </div>
            ...
            <ol className="breadcrumb mb-30">
              ...
              <li className="breadcrumb-item">
                <a href="/admin/product/create">Parlour Create</a>
              </li>
