...
const getAllSalonList = async (data) => {
  try {
    let result = await api.get(Apis.GetAllSalonList, { params: data });
    if (result.data.error) {
      NotificationManager.error(result.data.error);
      return null;
    }
...
const getServiceList = async (data) => {
  try {
    let result = await api.get(Apis.GetServiceList, { params: data });
    if (result.data.error) {
      NotificationManager.error(result.data.error);
      return null;
    }
...
const getServiceByGender = async () => {
  try {
    let result = await api.get(Apis.GetServiceByGender);
    if (result.data.error) {
      NotificationManager.error(result.data.error);
      return null;
    }
