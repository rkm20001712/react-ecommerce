...
export default class Filterbycategory extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <button togglefilter="offcanvas1" className="filter-btn pull-bs-canvas-right" variant="contained"><i class="fa fa-th" aria-hidden="true"></i> Filters</button>
                ...
                <Helmet>
                    <meta charSet="utf-8" />
                    <title>{list ? list.title : null}</title>
                    <meta name="description" content={list ? list.desc : null}></meta>
                    <meta name="keyword" content={list ? list.keyword : null}></meta>
