                            ...
                            <div className="col-lg-12">
                                <div className="user-dt">
                                    <div className="user-img">
                                        <img src="/images/avatar/img-5.jpg" alt ="rewards"/>
                                    ...
                                    <div className="earn-points"><img src="/images/Dollar.svg" alt="Dollar" />Points : <span>20</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-4 col-md-12">
                                            <div className="pdpt-bg rewards-coupns">
                                                <div className="reward-body-dtt">
                                                    <div className="reward-img-icon">
                                                        <img src="images/discount.svg" alt="gift" />
                                                    </div>
                                                    <span className="rewrd-title">Offer</span>
                                        ...
                                        <div className="col-lg-4 col-md-12">
                                            <div className="pdpt-bg rewards-coupns">
                                                <div className="reward-body-dtt">
                                                    <div className="reward-img-icon">
                                                        <img src="/images/coupon.svg" alt="cuupon" />
                                                    </div>
                                                    <span className="rewrd-title">Coupon Won</span>
