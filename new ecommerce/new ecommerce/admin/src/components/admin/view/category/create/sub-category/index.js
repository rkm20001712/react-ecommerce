...
export default class SubCategory extends Component {
    constructor(props) {
        super(props);
        this.state = {
            name: '', selectCategory: '', getList: [], title:'', description: '', content:''
        }
    }
    handleChange(e) {
    ...
    handleSubmit = async event => {
        ...
        let data = { sub_name: name, slug: slug, categoryId: selectCategory,  title: title, keyword: keyword, desc: content };
        swal({
            title: "Are you sure?",
                            ...
                            <div className="card-body-table">
                                <div className="news-content-right pd-20">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" placeholder="Ex:- new title" name="title" onChange={(e) => this.handleChange(e)} />
                                    </div>
